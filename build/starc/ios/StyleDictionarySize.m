...
// Generated on Thu, 27 Jun 2024 09:51:16 GMT
...
float const TypographyHeading2FontWeight = 700;
float const TypographyTitleFontWeight = 700;
float const TypographyBody1AccentFontWeight = 600;
float const TypographyBody1FontWeight = 400;
float const TypographyBody2AccentFontWeight = 600;
float const TypographyBody2FontWeight = 400;
float const TypographyCaption1AccentFontWeight = 600;
float const TypographyCaption1FontWeight = 300;
float const TypographyCaption2AccentFontWeight = 600;
float const TypographyCaption2FontWeight = 300;
